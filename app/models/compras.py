...
from app.models.db_schemas import CATALOGO_SCHEMA, COMPRAS_SCHEMA, USUARIOS_SCHEMA, table_ref
...
class Local(Base):
    ...
    id_cadena: Mapped[int] = mapped_column(ForeignKey(table_ref(COMPRAS_SCHEMA, "cadena.id_cadena")), nullable=False)
    ...
    cadena: Mapped["Cadena"] = relationship(back_populates="locales")
