from sqlalchemy import BigInteger, String, Text, DateTime, Time, DECIMAL, ForeignKey
...
class Entrenamiento(Base):
    ...
    id_entrenamiento: Mapped[int] = mapped_column(BigInteger, primary_key=True)
...
class EntrenamientoAerobico(Base):
    ...
    id_aerobico: Mapped[int] = mapped_column(BigInteger, primary_key=True)
...
class EntrenamientoFuerza(Base):
    ...
    id_fuerza: Mapped[int] = mapped_column(BigInteger, primary_key=True)
    id_entrenamiento: Mapped[int] = mapped_column(ForeignKey("entrenamiento.id_entrenamiento"))
...
class Ejercicio(Base):
    ...
    id_ejercicio: Mapped[int] = mapped_column(BigInteger, primary_key=True)
